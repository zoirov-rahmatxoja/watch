                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($services as $str)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a class="text-success mr-2" href="{{ route('services.edit', $str->id) }}"><i class="nav-icon fas fa-pen font-weight-bold"></i></a>
                                                    <a data-toggle="modal" data-target="#deletesModal{{$str->id}}" class="text-danger mr-2" href="{{ route('services.destroy', $str->id) }}"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
                                                        ...
                                                        <div class="modal-dialog" role="document">  
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('services.destroy', $str->id) }}" method="post">
                                                                        @method('DELETE')
                                                                        @csrf
