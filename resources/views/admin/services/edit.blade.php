                    ...
                    <div class="card-body">
                        <form action="{{ route('services.update', $services->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                    <label>Title</label>
                                    <input class="form-control @error('title_uz') is-invalid @enderror" value="{{ $services->title_uz }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('title_ru') is-invalid @enderror" value="{{ $services->title_ru }}"
